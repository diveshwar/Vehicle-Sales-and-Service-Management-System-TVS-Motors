...
class Employee_Menu:
    def __init__(self, root, ls, frame_old, frame_run):
        ...
        # Labeling the page.
        self.title = Label(self.frame, text='TVS MOTORS', font=('Algerian', 25, 'bold'), bg="#163148",
                           fg="#ffffff").pack(
            side=TOP)
        ...
        self.title1 = Label(self.frame2, text='ADMIN MANAGEMENT', font=('Algerian', 22, 'bold'),
                            bg='#ffffff').pack(
            side=TOP)
        ...
        self.new_student_btn = Button(self.frame2, text='MANAGE ACCOUNTS', bd=0, bg='#fbf8e6', image=self.photo_new_student,
        ...
        self.fees_btn = Button(self.frame2, text='MANAGE FEES', bd=0, bg='#fbf8e6', image=self.photo_fees,
