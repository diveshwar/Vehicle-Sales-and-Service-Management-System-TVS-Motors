...
class Class_Marks:
    def __init__(self, root, ls, frame_old):
        ...
        # Labeling the title
        title = Label(self.frame, text='MARK MANAGER', font=('Algerian', 25, 'bold'),
        ...
        lbl_sub1 = Label(Manage_Frame, text="Physics: ", bg="LightBlue", fg="RED", font=("times new roman", 14, "bold"))
        ...
        lbl_sub2 = Label(Manage_Frame, text="Chemistry: ", bg="LightBlue", fg="RED", font=("times new roman", 14, "bold"))
        ...
        lbl_sub3 = Label(Manage_Frame, text="Mathematics: ", bg="LightBlue", fg="RED", font=("times new roman", 14, "bold"))
        ...
        lbl_sub4 = Label(Manage_Frame, text=" English", bg="LightBlue", fg="RED", font=("times new roman", 14, "bold"))
        ...
        lbl_sub5 = Label(Manage_Frame, text="COMP.SCIENCE: ", bg="LightBlue", fg="RED", font=("times new roman", 14, "bold"))
        ...
        lbl_sub6 = Label(Manage_Frame, text="BIOLOGY: ", bg="LightBlue", fg="RED", font=("times new roman", 14, "bold"))
        ...
        self.Student_table = ttk.Treeview(Table_Frame,
                                          columns=("Roll", "PHY", "CHEM", "MATH", "ENG", "CSC", "BIO"),
        ...
        self.Student_table.heading("PHY", text="PHY")
        self.Student_table.heading("CHEM", text="CHEM")
        self.Student_table.heading("MATH", text="MATH")
        self.Student_table.heading("ENG", text="ENG")
        self.Student_table.heading("CSC", text="CSC")
        self.Student_table.heading("BIO", text="BIO")

        self.Student_table['show'] = 'headings'
        self.Student_table.column("Roll", width=100)
        self.Student_table.column("PHY", width=100)
        self.Student_table.column("CHEM", width=100)
        self.Student_table.column("MATH", width=100)
        self.Student_table.column("ENG", width=100)
        self.Student_table.column("CSC", width=100)
        self.Student_table.column("BIO", width=100)
    ...
    def add_data(self):
        ...
        if len(rows)!=0:
            c.execute("INSERT INTO student_marks VALUES (%s,%s,%s,%s,%s,%s,%s)", (self.Roll_No_var.get(),
                                                                          self.Subject_1.get(),
                                                                          self.Subject_2.get(),
                                                                          self.Subject_3.get(),
                                                                          self.Subject_4.get(),
    ...
    def update_data(self):
        conn=mysql.connector.connect(host="localhost",user="root",passwd='79sumathi',database="tv")
        cur = conn.cursor()
        cur.execute("UPDATE student_marks SET Physics='{}', Chemistry='{}', Mathematics='{}', English='{}', Comp_Science='{}', Biology='{}' where Roll_no= {}"
