...
class Class_Marksheet:
    def __init__(self, root, ls, frame_old, roll):
        ...
        # Labeling the title
        title = Label(self.frame, text='REPORT CARD ', font=('Algerian', 25, 'bold'),
        ...
        # Label Nirma
        uni_labl = Label(Manage_Frame, anchor=CENTER, bg='lightblue', text='TVD UNIVERSITY', font=('Algerian', 20))
        uni_labl.pack(side=TOP,fill=X)

        # Creating the Sr. No.
        srl_lbl = Label(Manage_Frame, bg='lightblue', text="ROLL NO.", font=('Times New Roman', 18))
        ...
        srl_lbl = Label(Manage_Frame, bg='lightblue', text="Physics", font=('Times New Roman', 16))
        ...
        srl_lbl = Label(Manage_Frame, bg='lightblue', text="Chemistry", font=('Times New Roman', 16))
        ...
        srl_lbl = Label(Manage_Frame, bg='lightblue', text="Mathematics", font=('Times New Roman', 16))
        ...
        srl_lbl = Label(Manage_Frame, bg='lightblue', text=" English", font=('Times New Roman', 16))
        ...
        srl_lbl = Label(Manage_Frame, bg='lightblue', text="COMP.SCIENCE", font=('Times New Roman', 16))
        ...
        srl_lbl = Label(Manage_Frame, bg='lightblue', text="BIOLOGY", font=('Times New Roman', 16))
        ...
        if flag==1:
            total_lbl.config(text="FAILED", fg='red')
